...
//   const fullDateString = `01/${value}`; // Crée une date complète (ex: 01/07/2025)
...
//   // ✅ Met à jour à la fois le mois du calendrier et la date sélectionnée
//   setCalendarMonth(parsed);
//   setSelectedDate(parsed);  // <-- Ajoute ceci
// };
//   return (
//     <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl max-w-xl mx-auto mt-6">
//       <div className="mb-4">
...
const DateSelector = () => {
  ...
  const handleInputChange = (e) => {
    ...
    const fullDateString = `01/${value}`; // Ajoute le jour "01" pour avoir un format complet
    const parsed = parse(fullDateString, "dd/MM/yyyy", new Date());
    ...
    // ✅ Mettre à jour le mois affiché ET sélectionner la date
    setCalendarMonth(parsed);
    ...
    <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl max-w-xl mx-auto mt-6">
      ...
      >
        <DayPicker
          ...
          showOutsideDays
          modifiersClassNames={{
            selected: "bg-blue-600 text-white font-bold rounded-full shadow-lg",
